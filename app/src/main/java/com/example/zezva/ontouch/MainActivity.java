...
public class MainActivity extends AppCompatActivity  implements View.OnTouchListener , View.OnClickListener {
    ...
    private GiftEnd gift_end_timer_task;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        image_for_gift.setImageResource(R.drawable.gift);
    ...
    private void scheduleGift_End_Timer() {
        ...
        gift_end_timer_task = new GiftEnd(handler_gift_end);
        ...
        if(isPaused){
            if(isGameInPlay){
                ...
                if(is_Timer_for_gift_end){
                    GiftEnd gift_end_timer_task = new GiftEnd(handler_gift_end);
    ...
    private void schedule_gift_end_timer_from_resume(GiftEnd gift_end_timer_task) {
        gift_end_timer = new Timer();
        gift_end_timer.schedule(gift_end_timer_task, 0, 1000);
    }
